...
public class ServicesExample {
	...
	public void addWebSocketDataToDB() throws JSONException, IOException, WebSocketException {
		...
		// [{\"name\":\"matches\",\"product_ids\":[\"BTC-USD\", \"BTC-GBP\" ,
		// \"BTC-EUR\", \"ETH-GBP\" , \"ETH-USD\" , \"ETH-EUR\" , \"LTC-USD\" ,
		// \"LTC-GBP\" , \"LTC-EUR\"]}]}");
		// customWebSocket.getWebSocket("wss://ws.bitmex.com/realtime?subscribe=trade:XBTUSD",
		// true, "");
		customWebSocket.getWebSocket("wss://ws.bitmex.com/realtime?subscribe=trade:XBTEUR", true, "");
		// customWebSocket.getWebSocket("wss://ws.bitmex.com/realtime?subscribe=trade:ETHUSD",
		// true, "");
